  ...
  <n-modal v-model:show="modalVisible" preset="card" :title="title" class="w-700px">
    <n-form ref="formRef" label-placement="left" :label-width="80" :model="formModel" :rules="rules">
      <n-grid :cols="24" :x-gap="18">
        ...
        <n-form-item-grid-item :span="12" label="在线时长" path="age">
          <n-input-number v-model:value="formModel.age" clearable />
        </n-form-item-grid-item>
        <n-form-item-grid-item :span="12" label="角色" path="gender">
...
const rules: Record<keyof FormModel, FormItemRule | FormItemRule[]> = {
  ...
  age: createRequiredFormRule('请输入在线时长'),
  gender: createRequiredFormRule('请选择角色'),
