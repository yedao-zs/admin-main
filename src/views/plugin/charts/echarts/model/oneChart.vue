  ...
  series: [
    {
      ...
      data: [
        { value: 40, name: 'IDMP数字化 1' },
        { value: 38, name: 'IDMP数字化 2' },
        { value: 32, name: 'IDMP数字化 3' },
        { value: 30, name: 'IDMP数字化 4' },
        { value: 28, name: 'IDMP数字化 5' },
        { value: 26, name: 'IDMP数字化 6' },
        { value: 22, name: 'IDMP数字化 7' },
        { value: 18, name: 'IDMP数字化 8' }
      ]
    }
  ]
}) as Ref<ECOption>;
