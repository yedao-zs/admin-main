...
const tabData = ref<App.MessageTab[]>([
  {
    ...
    list: [
      ...
      { id: 4, icon: 'ri:message-3-line', title: 'IDMP智慧数字化管理平台 1.0.0 版本正在筹备中', date: '2022-06-17' },
      { id: 2, icon: 'ri:message-3-line', title: 'IDMP智慧数字化管理平台 0.9.6 版本发布了', date: '2022-06-16' },
      { id: 3, icon: 'ri:message-3-line', title: 'IDMP智慧数字化管理平台 0.9.5 版本发布了', date: '2022-06-07' },
      {
        id: 5,
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: 'Soybean 正在忙于为IDMP智慧数字化管理平台写项目说明文档！',
      ...
      },
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: 'Soybean 准备为IDMP智慧数字化管理平台 1.0的发布做充分的准备工作！',
      ...
      },
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: '@yanbowe 向IDMP智慧数字化管理平台提交了一个bug，多标签栏不会自适应。',
      ...
      },
      {
        ...
        title: '项目动态',
        svgIcon: 'avatar',
        description: 'Soybean 在2021年5月28日创建了开源项目IDMP智慧数字化管理平台！',
